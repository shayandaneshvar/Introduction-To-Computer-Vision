...
min_centre_distance = 50  # minimum distance between the centres of detected circles
resolution = 1.1  # resolution of parameters (centre, radius) relative to image resolution
